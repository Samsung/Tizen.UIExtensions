...
namespace Tizen.UIExtensions.ElmSharp
{
	...
	public class CollectionView : EBox, ICollectionViewController
	{
		...
		void SendScrolledEvent()
		{
			...
			args.HorizontalOffset = DPExtensions.ConvertToScaledDP(ViewPort.X);
			args.HorizontalDelta = DPExtensions.ConvertToScaledDP(ViewPort.X - _previousHorizontalOffset);
			args.VerticalOffset = DPExtensions.ConvertToScaledDP(ViewPort.Y);
			args.VerticalDelta = DPExtensions.ConvertToScaledDP(ViewPort.Y - _previousVerticalOffset);
