...
namespace NUIExGallery.TC
{
    ...
    public class CollectionViewSnapTest : TestCaseBase
    {
        ...
        public override string TestName => "CollectionView Snap Test1";

        public override string TestDescription => "CollectionView Snap Test1";
