...
namespace NUIExGallery.TC
{
    ...
    public class CollectionViewSnapTest2 : TestCaseBase
    {
        ...
        public override string TestName => "CollectionView Snap Test2";

        public override string TestDescription => "CollectionView Snap Test2";
