...
namespace ElmSharpExGallery.TC
{
    ...
    {
        public override string TestName => "CollectionViewTest4";

        public override string TestDescription => "CollectionViewTest4";
        ...
        public override void Run(Box parent)
        {
            ...
            collectionView.LayoutManager = new Ext.GridLayoutManager(true, 3, Ext.ItemSizingStrategy.MeasureAllItems, 10, 10);
