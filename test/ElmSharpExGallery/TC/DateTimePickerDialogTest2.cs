...
{
    public class DateTimePickerDialogTest2 : TestCaseBase
    {
        public override string TestName => "DateTimePickerDialogTest2";

        public override string TestDescription => "To test basic operation of TimePickerDialog";
